...
if questao != "1":
   print("Erro, digite o número 1 para começar.")
else:
   print("Iniciando...")
   time.sleep(3)
   for questao in range(11):
    ...
    if questao == 1:
      q1 = input("1) Quem foi o primeiro Papa da igreja Católica ? \n1 - Pedro \n2 - Tiago \n3 - Matias \n4 - André \n")
      if q1.lower() in ("1", "pedro"):
        print("Resposta correta, parabéns")
      else:
        print("Resposta incorreta.")
    elif questao == 2:
      q2 = input("2) Qual é o Papa atual da igreja Católica ? \n1 - Papa Paulo VI \n2 - Papa Francisco \n3 - Papa Leão XIV \n4 - Papa João Paulo II \n")
      if q2.lower() in("3", "leao xiv", "leão xiv"):
        print("Resposta correta, parabéns.")
      else: 
        print("Resposta incorreta.")
    elif questao == 3:
      q3 = input("3) Qual foi o Papa que durou apenas 33 dias no Papado ? \n1 - Papa Bento XV \n2 - Papa Pio XII \n3 - Papa Pio XI \n4 - Papa João Paulo I \n")
      if q3.lower() in("4", "joão paulo i", "joao paulo i"):
        print("Resposta correta, parabéns.")
      else: 
        print("Resposta incorreta.")
    elif questao == 4:
      q4 = input("4) Em qual país o Papa Bento XVI nasceu ? \n1 - Itália \n2 - Alemanha \n3 - Brasil \n4 - França \n")
      if q4.lower() in("2", "alemanha"):
        print("Resposta correta, parabéns.")
      else: 
        print("Resposta incorreta.")
    elif questao == 5:
      q5 = input("5) Qual Papa convocou o Concílio Vaticano II ? \n1 - Papa João XXIII \n2 - Papa Leão XIII \n3 - Papa Pio VI \n4 - Papa Bento XVI \n")
      if q5.lower() in("1", "joao xxiii", "joão xxiii"):
        print("Resposta correta, parabéns.")
      else: 
        print("Resposta incorreta.") 
    elif questao == 6:
